 ...
 */
public class Hot_Content_Adapter extends BaseAdapter {
    private List<ThreeVideoInfo> list = new ArrayList<>();
    ...
    public Hot_Content_Adapter(Activity context) {
        this.context = context;
        this.inflater = LayoutInflater.from(context);
        util = Util.getUtils(context);
    }

    public List<ThreeVideoInfo> getList() {
        return list;
    }

    public void setList(List<ThreeVideoInfo> list) {
        this.list = list;
    }
    ...
    private void setDataToUI(View convertView, ThreeViewHolder indexViewHolder, ViewGroup parent, final int position) {
        ...
        final ThreeVideoInfo info = list.get(position);
        ...
        Glide.with(context).
                ...
                into(indexViewHolder.three_images);
        indexViewHolder.three_images.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                sendUserDoData("10", new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new java.util.Date()));
    ...
    public void doPlay(int position) {
        ...
        ThreeVideoInfo threeVideoInfo = list.get(position);
