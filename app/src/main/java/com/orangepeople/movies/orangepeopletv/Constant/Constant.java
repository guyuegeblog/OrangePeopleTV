...
public class Constant {
     ...
     * 试用文件路径
     */
    public static final String TV_SHIYONG_MP4 = Util.getSDCardPath() + "//" + ".orangetv";

    public static final String TV_SHIYONG_MP4_FILE = ".orangemplook";

    public static final String TV_SHIYONG_MP4_ALL = Constant.TV_SHIYONG_MP4 + "/" + Constant.TV_SHIYONG_MP4_FILE;


    public static final String TV_SHIYONG_M3U8 = Util.getSDCardPath() + "//" + ".lookroot";

    public static final String TV_SHIYONG_FILE = ".orangelook";//.saal

    public static final String TV_SHIYONG_M3U8_ALL = Constant.TV_SHIYONG_M3U8 + "/" + Constant.TV_SHIYONG_FILE;

    public static final String TV_FIRST_REGISTER = ".orangefirsti";
    ...
    //    public static final int doDate = 0 * 60;//因为送7天，所以改成0
    public static final int doDate = 20 * 60;//20分钟
    public static boolean barra_show = true;

    //送tv时间
    public static final String send_Tv_Directory = Util.getSDCardPath() + "//.sendtvdireorange";

    public static final String send_Tv_File = ".sendorange";
